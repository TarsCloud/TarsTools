...
public class JceRefStructImpl extends ASTWrapperPsiElement implements JceRefStruct {

  public JceRefStructImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JceVisitor visitor) {
    visitor.visitRefStruct(this);
  }
