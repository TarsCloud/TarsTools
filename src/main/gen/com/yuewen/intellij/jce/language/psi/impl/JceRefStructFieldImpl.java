...
public class JceRefStructFieldImpl extends ASTWrapperPsiElement implements JceRefStructField {

  public JceRefStructFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JceVisitor visitor) {
    visitor.visitRefStructField(this);
  }
