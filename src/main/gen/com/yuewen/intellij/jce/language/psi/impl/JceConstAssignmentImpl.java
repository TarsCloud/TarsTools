...
public class JceConstAssignmentImpl extends ASTWrapperPsiElement implements JceConstAssignment {

  public JceConstAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JceVisitor visitor) {
    visitor.visitConstAssignment(this);
  }
