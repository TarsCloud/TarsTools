...
public class JceEnumTypeImpl extends JceNamedElementImpl implements JceEnumType {

  public JceEnumTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JceEnumMember> getEnumMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JceEnumMember.class);
  }
