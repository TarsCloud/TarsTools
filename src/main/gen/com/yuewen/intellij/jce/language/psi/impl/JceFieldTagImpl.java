...
public class JceFieldTagImpl extends ASTWrapperPsiElement implements JceFieldTag {

  public JceFieldTagImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getNumInt() {
    return findNotNullChildByType(NUM_INT);
  }
