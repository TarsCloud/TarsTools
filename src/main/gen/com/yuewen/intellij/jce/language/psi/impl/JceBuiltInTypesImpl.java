...
public class JceBuiltInTypesImpl extends ASTWrapperPsiElement implements JceBuiltInTypes {

  public JceBuiltInTypesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JceVisitor visitor) {
    visitor.visitBuiltInTypes(this);
  }
