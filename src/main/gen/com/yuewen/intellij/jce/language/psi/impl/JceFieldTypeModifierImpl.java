...
public class JceFieldTypeModifierImpl extends ASTWrapperPsiElement implements JceFieldTypeModifier {

  public JceFieldTypeModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JceVisitor visitor) {
    visitor.visitFieldTypeModifier(this);
  }
